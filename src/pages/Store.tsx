...
const Store = () => {
  ...
  const dummyProducts: ProductRecord[] = [
    {
      ...
      image: isMobile
        ...
        : InfertilityManagementKitDesktop,
  ...
  const handleOrderNow = (product: ProductRecord) => {
  ...
  return (
    <section className="min-h-screen py-10">
      <div className="container mx-auto px-4 pt-0">
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Explore our carefully selected range of authentic Ayurvedic
            products, crafted to support your daily health, wellness, and
            natural healing.
          </p>
      ...
      {/* Order Form Dialog - Maximum size with working scroll */}
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent
          className={`
          ${
            isMobile
              ? "max-w-full h-screen max-h-screen rounded-none p-0"
              : "max-w-[95vw] w-[1400px] h-[95vh] max-h-[95vh] rounded-2xl p-0"
          }
        ...
        >
          ...
          <div
            ...
            ${isMobile ? "sticky top-0 z-40 bg-white" : ""}
          `}
          >
            <DialogHeader>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            >
              <div className="grid gap-5">
                ...
                {/* Customer Details - 3 fields in a row */}
                ...
                {/* Address Details - 3 fields in a row */}
                <div className="space-y-2">
                  <Label className="text-sm font-semibold flex items-center gap-2 text-foreground">
                ...
                {/* Quantity and Notes - 3 fields in a row */}
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <div className="space-y-1.5">
              ...
              <div
                ...
                ${isMobile ? "fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm p-4 border-t shadow-lg" : ""}
              `}
              >
                <DialogFooter className="sm:justify-end gap-3">
                  <Button
                    ...
                    variant="outline"
                    onClick={() => setIsDialogOpen(false)}
                    className={`${isMobile ? "flex-1" : "min-w-[100px]"} h-11`}
                  >
                    Cancel
                  </Button>
                  <Button
                    ...
                    className={`${isMobile ? "flex-1" : "min-w-[160px]"} h-11 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 shadow-lg shadow-primary/20`}
                  >
                    {isSubmitting ? (
                      <>
