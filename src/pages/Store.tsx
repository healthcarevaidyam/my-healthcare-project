// Store.tsx - Only remove the dialog and add the import
...
import OrderDialog from "@/components/OrderDialog"; // Add this import
...
const Store = () => {
  ...
  return (
    <section className="min-h-screen py-10">
      ...
      {/* Checkout Dialog - Using the extracted component */}
      <OrderDialog
        isOpen={isDialogOpen}
