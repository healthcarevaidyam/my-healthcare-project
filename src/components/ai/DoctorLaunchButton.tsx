...
>
  {/* Tooltip Label */}
  <span className="absolute right-full mr-3 pointer-events-none opacity-100 transition-opacity duration-200 rounded-md bg-slate-900 px-2.5 py-1 text-xs font-medium text-white shadow-md whitespace-nowrap">
    Ask AI Doctor
  </span>
